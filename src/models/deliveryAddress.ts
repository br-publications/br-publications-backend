...
export interface DeliveryAddressCreationAttributes extends Optional<DeliveryAddressAttributes, 'id' | 'companyName' | 'contactPersonName' | 'altCountryCode' | 'altMobileNumber' | 'buildingName' | 'streetName' | 'area' | 'landmark' | 'deliveryInstructions' | 'textBookSubmissionId' | 'bookChapterSubmissionId' | 'createdAt' | 'updatedAt'> { }

class DeliveryAddress extends Model<DeliveryAddressAttributes, DeliveryAddressCreationAttributes> implements DeliveryAddressAttributes {
    public id!: number;
    ...
    static associate(models: any) {
        DeliveryAddress.belongsTo(models.TextBookSubmission, {
            foreignKey: 'textBookSubmissionId',
            as: 'textBookSubmission',
        });
        DeliveryAddress.belongsTo(models.BookChapterSubmission, {
