...
`
    ...
    BOOK_CHAPTER_EDITOR_SELECTED_BY_AUTHOR: {
        ...
        variables: ['editorName', 'authorName', 'bookTitle', 'chapters', 'assignedBy', 'frontendUrl', 'currentYear'],
        content: `
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>New Editor Selection</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td
                            style="background:linear-gradient(135deg,#1e3a6e,#2563eb);padding:36px 40px;text-align:center;">
                            <h1 style="margin:0;color:#ffffff;font-size:22px;font-weight:700;">BR Publications</h1>
                            <p style="margin:8px 0 0;color:#bfdbfe;font-size:14px;">Editor Selection Notification</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td
                            style="background:#eff6ff;border-bottom:3px solid #2563eb;padding:16px 40px;text-align:center;">
                            <p style="margin:0;color:#1d4ed8;font-size:15px;font-weight:600;">
                                ✅ You Have Been Selected as Editor
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:36px 40px;">
                            ...
                            <p style="margin:0 0 20px;color:#6b7280;font-size:14px;line-height:1.6;">
                                ...
                                This selection was made by <strong>{{assignedBy}}</strong>.
                            </p>
                                    ...
                                    <td style="padding:24px">
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td style="padding:10px 0;border-bottom:1px solid #e2e8f0;">
                                                    <span
                                                        style="color:#6b7280;font-size:12px;font-weight:600;text-transform:uppercase;">Chapters
                                                    </span><br />
                                                    <span style="color:#111827;font-size:15px;">{{chapters}}</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="padding:10px 0;">
                                                    <span
                                                        style="color:#6b7280;font-size:12px;font-weight:600;text-transform:uppercase;">Selected by
                                                    </span><br />
                                                    <span style="color:#111827;font-size:15px;">{{assignedBy}}</span>
                                                </td>
                                            </tr>
                            ...
                            <p style="margin:0 0 20px;color:#6b7280;font-size:14px;line-height:1.6;">
                                Please log in to the editorial dashboard to view and manage this submission.
                            </p>
